...
def sub_writer(sample, n, files, folder):
    ...
    f.write("transfer_input_files    = $(Proxy_path), samples/samples.py, FakeRatio_utils_dev.py, TauIDSFTool.py, CutsAndValues.py, Btag_eff_" + str(sample.year) + ".root, __init__.py, ./data\n")
