...
BTAG_ALGO   =   'DeepFlv'
BTAG_WP     =   'M'
ID_TAU_RECO_DEEPTAU_VSJET_LOOSE_ELE = 2 #byDeepTau2017v2p1VSjet ID working points (deepTau2017v2p1): bitmask 1 = VVVLoose, 2 = VVLoose, 4 = VLoose, 8 = Loose, 16 = Medium, 32 = Tight, 64 = VTight, 128 = VVTight
