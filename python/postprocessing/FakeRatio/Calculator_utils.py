...
def makeDir(name):
    if not path.exists(name):
        print('Creating output directory: ', name)
        os.makedirs(name)


lower_pt = {
    "Tau": [0, 30, 45, 60, 80, 100],
    "Electron": [0, 30, 45, 60, 80, 100],
    "Muon": [0, 30, 45, 60, 80, 100],
}
#lower_eta = [0, 1, 1.4, 2, 2.4]
#lower_eta_ele = [-2.4, -2, -1.4, -1, 0, 1, 1.4, 2, 2.4]
#[-2.5, -1.5, -1.0, 0., 1.0, 1.5, 2.5],
#lower_pt_ele = [0, 40, 60, 80, 100]
lower_eta = {
    "Tau": [-2.4, -1.2, 0, 1.2, 2.4],#[-2.4, -1.4, -1, 0, 1, 1.4, 2, 2.4],
    "Electron": [-2.4, -1.2, 0, 1.2, 2.4],#[-2.4, -2, -1.4, -1, 0, 1, 1.4, 2, 2.4],
    "Muon": [-2.4, -1.2, 0, 1.2, 2.4],#[-2.4, -2, -1.4, -1, 0, 1, 1.4, 2, 2.4],
}
#lower_eta_ele = [-2.4, -1.2, 0, 1.2, 2.4]
