...
python3 add_1finalMVA.py -y $year -f $folder --paths $bdt_sm_allbkg_v2_ul,$bdt_cW_allbkg_v2_ul,$bdt_cHW_allbkg_ul --branches $bdt_sm_allbkg_v2_branch,$bdt_cW_allbkg_v2_branch,$bdt_cHW_allbkg_branch -d DYJetsToLL_FxFx_$year #--scalers 
python3 add_1finalMVA.py -y $year -f $folder --paths $dnn_sm_path,$dnn_cW_path,$dnn_cHW_path --branches $dnn_sm_branch,$dnn_cW_branch,$dnn_cHW_branch --scalers $dnn_sm_scaler,$dnn_cW_scaler,$dnn_cHW_scaler -d DYJetsToLL_FxFx_$year
