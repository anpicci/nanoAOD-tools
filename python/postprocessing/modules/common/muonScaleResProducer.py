...
muonScaleRes2016 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2016.txt', 2016)
muonScaleRes2017 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2017.txt', 2017)
muonScaleRes2018 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2018.txt', 2018)
muonScaleResUL2016APV = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2016aUL.txt', 2016)
muonScaleResUL2016 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2016bUL.txt', 2016)
muonScaleResUL2017 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2017UL.txt', 2017)
muonScaleResUL2018 = lambda: muonScaleResProducer('roccor.Run2.v5', 'RoccoR2018UL.txt', 2018)
