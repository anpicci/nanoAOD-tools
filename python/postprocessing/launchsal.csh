...
set year = 'UL2017'
#reset
#python3 PrepareToPlot.py -f $folder -y $year -d WJets_Jbin_$year -c
python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year -d WJets_Jbin #--rw
