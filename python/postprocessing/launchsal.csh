...
set year = 'UL2017'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --rw --or -d VBS_SSWW_cW_UL2017,VBS_SSWW_cW_SM_UL2017
...
set year = 'UL2018'
#reset
python3 PrepareToPlot.py -f $folder -y $year --rw --or -d VBS_SSWW_aTGC_
...
set year = 'UL2016'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --or --rw -d VBS_SSWW_cHW_SM_UL2016
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year #--rw
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco lj --masscrit --deltaeta -y $year
...
set year = 'UL2016APV'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --or --rw -d ZZtoLep_
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year #--rw
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco lj --masscrit --deltaeta -y $year
