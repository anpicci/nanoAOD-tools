reset
set folder = vUL055 #### aQGC added, new fakes, systematics completed
#set folder = vUL055 #### same as UL035, but SF ele and met unclust sys

#######    2017   #######
set year = 'UL2017'
#reset
python3 PrepareToPlot.py -f $folder -y $year --rw --or -d VBS_SSWW_SM_,VBS_SSWW_c
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year -d VBS_SSWW_aTGC_ -c
