...
set folder = vUL045 #### same as UL035, but SF ele and met unclust sys

#######    2017   #######
set year = 'UL2017'
#reset
#python3 PrepareToPlot.py -f $folder -y $year -d WJets_$year
python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year -d Data -c
...
#reset
#python3 PrepareToPlot.py -f $folder -y $year -d WJets_$year
python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year -d Data -c #--rw #-d DataEle_$year,DataMu_$year #--rw
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco lj --masscrit --deltaeta -y $year
