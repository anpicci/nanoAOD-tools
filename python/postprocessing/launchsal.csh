...
#######    2016   #######
set year = 'UL2016'
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year #-d DataEle
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco lj --masscrit --deltaeta -y $year
python3 PrepareToPlot.py -f $folder -y $year # -d Data

#######    2017   #######
set year = 'UL2017'
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco jl --masscrit --deltaeta -y $year #-d DataMu
#python3 SetAndLaunchCondorRun_old.py -f $folder --reco lj --masscrit --deltaeta -y $year
python3 PrepareToPlot.py -f $folder -y $year # -d Data
