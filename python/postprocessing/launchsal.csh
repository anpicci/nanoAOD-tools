...
set year = 'UL2017'
#reset
python3 PrepareToPlot.py -f $folder -y $year -d VBS_SSWW_aQGC_ --or --rw
#python3 PrepareToPlot.py -f $folder -y $year -d DataEle_UL2017 --rw
...
set year = 'UL2018'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --rw -v TT_,WJets_ -d VG_
...
set year = 'UL2016'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --rw -d TTTo2L2Nu_,ZZtoLep_,TVX_ -y UL2016
#python3 PrepareToPlot.py -f $folder -y $year --rw -d VBS_SSWW_aQGC -y UL2016
...
set year = 'UL2016APV'
#reset
#python3 PrepareToPlot.py -f $folder -y $year --rw -d VBS_SSWW_aQGC_ --or
