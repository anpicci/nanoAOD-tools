...
set year = UL2016M
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/electron/countings/*/*$year\_*
#python3 makeplot.py -y $year --lep electron --sr -f $folder0 -p --ch $channel --syst noSyst --test -d WrongSign_$year -v m_jj --count --syst noSyst --noweight
...
#python3 makeplot.py -y $year --lep electron --presel -f $folder0 -p --ch $channel  -v leadjet_eta,subleadjet_eta --syst noSyst --test -d WrongSign_$year,DYJetsToLL_FxFx_$year,TTTo2L2Nu_$year,FakeMu_$year,DataMu_$year 
...
#set year = UL2016M
#python3 makeplot.py -y $year --lep electron --sr -f $folder0 -p --ch $channel --syst noSyst  -d FakeMu_$year --syst noSyst 
