...
#rm /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/electron/*$year1*root #countings
...
####### year1bis #######################
#rm /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/electron/*$year1bis*root #countings
...
#rm /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/electron/*$year2*root #countings
...
python3 makeplot.py -y $year3 --lep electron --ws -f $folder0 -p --ch $channel --wfake incl_vsjet2 --count --bvetoL #--cut "m_jj>=500"
...
python3 makeplot.py -y $year3 --lep electron --dy -f $folder0 -p --ch $channel --wfake incl_vsjet2 --count --bvetoL #--cut "m_jj>=500"
