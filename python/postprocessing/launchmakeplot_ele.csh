...
python3 makeplot.py -y $year2 --lep electron --sr -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_FxFx_$year2 #--syst noSyst
python3 makeplot.py -y $year2 --lep electron --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_FxFx_$year2 #--syst noSyst
python3 makeplot.py -y $year2 --lep electron --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_FxFx_$year2 #--syst noSyst
python3 makeplot.py -y $year2 --lep electron --wsdy -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_FxFx_$year2 --bvetoL #--syst noSyst
