...
for year in years:
    ...
    for lep in leptons:
        ...
        variables.append(variabile(lep2[0] + '_mass',  lep2[1] + ' mass [GeV]',  wzero+'*('+cutbase+')', 10, 0., 2.))
        ...
        variables.append(variabile('deltaEta_jj', '#Delta #eta_{jj}',  wzero+'*('+cutbase+')', 16, -8., 8.))#nbin_deltaeta_jj, bin_deltaeta_jj))#
