...
def sub_writer(sample, n, files, folder):
    ...
    f.write("transfer_input_files    = $(Proxy_path), samples/samples.py, skimtree_utils_ssWW_wFakes.py, CutsAndValues_bu.py, FR_vsjet2_vsmuT_ZZ.root, FR_vsjet4_vsmuT_ZZ.root, ./data/leptonSF/Muon_RunBCDEF_SF_ID_2017.root, TauIDSFTool.py, EFTOperator_dict.py, Btag_eff.root, __init__.py, ./data\n")
