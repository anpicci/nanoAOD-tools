...
def sub_writer(sample, n, files, folder):
    ...
    f.write("transfer_input_files    = $(Proxy_path), samples/samples.py, skimtree_utils_ssWW_wFakes.py, CutsAndValues_" + tagyear + ".py, FR_vsjet2_" + str(sample.year) + ".root, FR_vsjet4_" + str(sample.year) + ".root, ./data/leptonSF/Muon_RunBCDEF_SF_ID_2017.root, TauIDSFTool.py, EFTOperator_dict.py, Btag_eff_" + str(sample.year) + ".root, VV_NLO_LO_CMS_mjj.root, /afs/cern.ch/user/t/ttedesch/public/VBSTagger_XGB.p, __init__.py, ./data\n")
