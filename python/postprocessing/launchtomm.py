...
for year in years:
    for scenario in scenarios:
        os.system("python3 add_1finalMVA.py -y " + year + " -f " + folder + " --paths " + dnn_sm_path_bal + "," + dnn_cW_path_bal + "," + dnn_cHW_path_bal + " --branches " + dnn_sm_branch_bal + "," + dnn_cW_branch_bal + "," + dnn_cHW_branch_bal + " --scalers " + dnn_sm_scaler_bal + "," + dnn_cW_scaler_bal + "," + dnn_cHW_scaler_bal + " -d TT_" + year)
        os.system("python3 add_1finalMVA.py -y " + year + " -f " + folder + " --paths " + dnn_sm_path_nobal + "," + dnn_cW_path_nobal + "," + dnn_cHW_path_nobal + " --branches " + dnn_sm_branch_nobal + "," + dnn_cW_branch_nobal + "," + dnn_cHW_branch_nobal + " --scalers " + dnn_sm_scaler_nobal + "," + dnn_cW_scaler_nobal + "," + dnn_cHW_scaler_nobal + " -d TT_" + year)
        os.system("python3 add_1finalMVA.py -y " + year + " -f " + folder + " --paths " + dnn_sm_path_bal + "," + dnn_cW_path_bal + "," + dnn_cHW_path_bal + " --branches " + dnn_sm_branch_bal + "," + dnn_cW_branch_bal + "," + dnn_cHW_branch_bal + " --scalers " + dnn_sm_scaler_bal + "," + dnn_cW_scaler_bal + "," + dnn_cHW_scaler_bal + " -d TTTo2L2Nu_" + year)
        os.system("python3 add_1finalMVA.py -y " + year + " -f " + folder + " --paths " + dnn_sm_path_nobal + "," + dnn_cW_path_nobal + "," + dnn_cHW_path_nobal + " --branches " + dnn_sm_branch_nobal + "," + dnn_cW_branch_nobal + "," + dnn_cHW_branch_nobal + "--scalers " + dnn_sm_scaler_nobal + "," + dnn_cW_scaler_nobal + "," + dnn_cHW_scaler_nobal + " -d TTTo2L2Nu_" + year)
