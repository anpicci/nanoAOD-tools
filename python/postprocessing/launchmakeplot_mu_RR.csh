...
set folder0 = v100_RR2017 #_tagger_DataSplit_MCnoSplit
set channel = "ltau" 
set user = 'ttedesch'
...
#python3 makeplot.py -y $year2 --lep muon --sr -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count --syst noSyst --user $user
python3 makeplot_rdf.py -y $year2 --lep muon --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count --user $user -d DataMu_2017 --horn
#python3 makeplot.py -y $year2 --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count --syst noSyst --user $user
#python3 makeplot.py -y $year2 --lep muon --ws -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count --syst noSyst --user $user
#python3 makeplot.py -y $year2 --lep muon --dy -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count --syst noSyst --user $user
