...
#python3 makeplot.py -y $year1 --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count
#python3 makeplot.py -y $year1 --lep muon --dy -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count
