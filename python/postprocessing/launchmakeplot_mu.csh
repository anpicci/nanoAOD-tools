...
set year = UL2018
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/muon/countings/*/*$year*
python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d WrongSign_$year 
python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d WrongSign_$year 
python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d WrongSign_$year 
python3 makeplot.py -y $year --lep muon --wsdy -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d WrongSign_$year --bvetoL 
