...
set year = UL2017
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/muon/countings/*/*$year\_*
#python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --count -v DNN_SM_UL035_v2 -d DataMu_$year
#,DNN_cW_UL035_v2,BDT_SM_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,leadjet_pt,lepton_pt,MET_pt
#python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --count -v m_o1,DNN_SM_UL035_v2,DNN_cW_UL035_v2,BDT_SM_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,leadjet_pt,lepton_pt,MET_pt
#python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --count -v m_o1,DNN_SM_UL035_v2,DNN_cW_UL035_v2,BDT_SM_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,leadjet_pt,lepton_pt,MET_pt
#python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --count -v m_o1,DNN_SM_UL035_v2,DNN_cW_UL035_v2,BDT_SM_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,leadjet_pt,lepton_pt,MET_pt
...
set year = UL2018
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/muon/countings/*/*$year*
#python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --count -v countings,m_o1,leadjet_pt,lepton_pt,MET_pt,DNN_SM_UL035_v2,BDT_SM_UL035_v2
#,DNN_cW_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,
python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --count -v countings,m_o1,leadjet_pt,lepton_pt,MET_pt,DNN_SM_UL035_v2,BDT_SM_UL035_v2
#,DNN_cW_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,
#python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --count -v countings,m_o1,leadjet_pt,lepton_pt,MET_pt,DNN_SM_UL035_v2,BDT_SM_UL035_v2
#,DNN_cW_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2,
#python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --count -v countings,m_o1,leadjet_pt,lepton_pt,MET_pt,DNN_SM_UL035_v2,BDT_SM_UL035_v2
#,DNN_cW_UL035_v2,BDT_cW_UL035_v2,BDT_cHW_UL035_v2, 
