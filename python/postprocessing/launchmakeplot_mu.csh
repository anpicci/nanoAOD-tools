...
#python3 makeplot.py -y $year1 --lep muon --sr -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_$year1 
#python3 makeplot.py -y $year1 --lep muon --bveto -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
python3 makeplot.py -y $year1 --lep muon --ws -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
#python3 makeplot.py -y $year1 --lep muon --wjets -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
python3 makeplot.py -y $year1 --lep muon --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
#python3 makeplot.py -y $year1 --lep muon --qcd -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
python3 makeplot.py -y $year1 --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4  --count -d DYJetsToLL_$year1 
python3 makeplot.py -y $year1 --lep muon --dy -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d DYJetsToLL_$year1 
