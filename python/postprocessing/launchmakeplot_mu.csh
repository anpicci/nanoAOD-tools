...
set year3 = UL2018
#set year3 = 2018
set folder0 = vUL005 #_tagger_DataSplit_MCnoSplit
#set folder0 = v100 
set channel = "ltau" 
...
python3 makeplot.py -y $year2 --lep muon --sr -f $folder0 -p --ch $channel --wfake incl_vsjet2 --count 
python3 makeplot.py -y $year2 --lep muon --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet2 --count 
python3 makeplot.py -y $year2 --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet2 --count 
