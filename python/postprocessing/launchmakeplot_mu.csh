...
#################### year1bis #################
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/muon/*$year1bis_*root #countings
...
python3 makeplot.py -y $year2 --lep muon --sr -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d TTTo2L2Nu_$year2
python3 makeplot.py -y $year2 --lep muon --ttbar -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d TTTo2L2Nu_$year2
python3 makeplot.py -y $year2 --lep muon --fakes -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count -d TTTo2L2Nu_$year2
python3 makeplot.py -y $year2 --lep muon --wsdy -f $folder0 -p --ch $channel --wfake incl_vsjet4 --count --bvetoL -d TTTo2L2Nu_$year2
