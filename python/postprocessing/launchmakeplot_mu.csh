...
set year = UL2016M
#rm -rf /eos/home-a/apiccine/VBS/nosynch/$folder0/plot/muon/countings/*/*$year\_*
python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --count --tDMcut -d WpWpJJ_QCD_$year,WpWpJJ_EWK_$year
python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --count --tDMcut -d WpWpJJ_QCD_$year,WpWpJJ_EWK_$year
python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --count --tDMcut -d WpWpJJ_QCD_$year,WpWpJJ_EWK_$year
python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --count --tDMcut -d WpWpJJ_QCD_$year,WpWpJJ_EWK_$year
python3 makeplot.py -y $year --lep muon --presel -f $folder0 -p --ch $channel --count --tDMcut -d WpWpJJ_QCD_$year,WpWpJJ_EWK_$year
