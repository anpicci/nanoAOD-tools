...
##python3 makeplot.py -y $year --lep muon --presel -f $folder0 -p --ch $channel --count --tDMcut -v countings --syst noSyst 
...
#python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --count --tDMcut -v countings --syst noSyst 
#python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --count --tDMcut -v countings --syst noSyst 
#python3 makeplot.py -y $year --lep muon --presel -f $folder0 -p --ch $channel --count --tDMcut -v leadjet_eta,subleadjet_eta --syst noSyst 
...
set year = ULRunII
#python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --count --tDMcut -v m_o1 
#python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --count --tDMcut -v m_o1 
#python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --count --tDMcut -v m_o1 
#python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --count --tDMcut -v m_o1 
#python3 makeplot.py -y $year --lep muon --presel -f $folder0 -p --ch $channel --count --tDMcut -v leadjet_eta,subleadjet_eta --syst noSyst
