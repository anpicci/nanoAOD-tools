...
#set year = ULRunII
#python3 makeplot.py -y $year --lep muon --sr -f $folder0 -p --ch $channel --syst noSyst --count -v DNN_SM_final_1 --noweight
#python3 makeplot.py -y $year --lep muon --ttbar -f $folder0 -p --ch $channel --syst noSyst --count -v DNN_SM_final_1 --noweight
#python3 makeplot.py -y $year --lep muon --fakes -f $folder0 -p --ch $channel --syst noSyst --count -v DNN_SM_final_1 --noweight
#python3 makeplot.py -y $year --lep muon --wsdy --bvetoL -f $folder0 -p --ch $channel --syst noSyst --count -v DNN_SM_final_1 --noweight
