...
###python submit_crab_fake.py -d ZZtoLep_$year -r -t HT
##python submit_crab_fake.py -d TT_$year -r -t HT
python submit_crab_fake.py -d DYJetsToLLM5to50_$year -s -t HT

#set year = '2017'
#python submit_crab_fake.py -d ZZtoLep_$year --status -t HT
#python submit_crab_fake.py -d OtherWS_$year --status -t HT
#python submit_crab_fake.py -d DataHT_$year --status HT
